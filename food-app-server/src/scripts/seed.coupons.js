...
const restaurant_model_1 = require("../models/restaurant.model"); // Optional, to get a real restaurantId
async function main() {
    await (0, database_1.connectDB)();
    console.log('Seeding coupons...');
    await coupon_model_1.CouponModel.deleteMany({});
    console.log('Old coupons removed');
    // Optional: Find a real restaurant to link a coupon to it
    const firstRestaurant = await restaurant_model_1.RestaurantModel.findOne().lean();
    ...
    for (const couponData of coupons) {
        ...
        await coupon_model_1.CouponModel.create(couponData);
        created += 1;
    }
